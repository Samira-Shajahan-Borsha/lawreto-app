            ...
            <h1 className='fs-1 text-success mb-3 text-center fw-bold mb-5'>{name}</h1>
            {
                submitted
                    ...
                    <Row className='align-items-center p-5'>
                        <Col className='w-100 d-flex justify-content-center py-5'>
                            {
                                user?.photoURL ?
                                    <img src={user?.photoURL} alt="imageURL"/>
                                    :
                                    <FaUser className='w-50'></FaUser>
                            }
                        </Col>
                        <Col>
                            <p className='fs-1 text-dark fw-semibold'>Thank you for Booking! {user?.displayName}</p>
                        </Col>
                    </Row>
                    :
